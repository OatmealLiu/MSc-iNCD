...
class Herb19Data:
    def __init__(self, args):
        ...
        self.whole_training_set_once = HerbariumDataset19(no_aug_transform=False, transform=self.transform_once,
                                                          root=os.path.join(self.root, 'small-train'))
        self.whole_training_set = HerbariumDataset19(no_aug_transform=True, transform=self.transform_twice,
                                                     root=os.path.join(self.root, 'small-train'))
        self.whole_test_dataset = HerbariumDataset19(no_aug_transform=False, transform=self.transform_plain,
