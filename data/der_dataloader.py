...
class CIFAR10(data.Dataset):
    ...
    def __init__(self, root, split='train+test',
                 transform=None, no_aug_transform=False, target_transform=None,
    ...
    def __getitem__(self, index):
        ...
        if self.transform is not None and self.return_no_aug_transform is True:
            ...
            return img, not_aug_img, target, index
    ...
    def get_dataset(self, split='train', aug=None, target_list=range(5), to_neighbors_dataset_indices=None):
        if aug == 'once':
            ...
            dataset = CIFAR10(root=self.root, split=split,
                              transform=self.transform_twice,
                              no_aug_transform=True,
...
class ImageFolder(data.Dataset):
    ...
    def __init__(self, transform=None, no_aug_transform=False, target_transform=None, samples=None, loader=pil_loader):
...
class TinyImageNetData:
    ...
    def get_dataset(self, split='train', aug=None, target_list=range(180), to_neighbors_dataset_indices=None):
        ...
        if aug == 'once':
            ...
            dataset = ImageFolder(transform=self.transform_twice, no_aug_transform=True,
                                  samples=samples)
        elif aug == 'fixmatch':
