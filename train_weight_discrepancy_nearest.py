...
from methods.weight_discrepancy_nearest_method import WeightDiscrepancy
...
if __name__ == "__main__":
    ...
    parser.add_argument('--w_topk', default=1, type=int)
    ...
    model_dir = os.path.join(args.exp_root, f"{runner_name}_{args.model_name}_{args.dataset_name}_Steps{args.num_steps}_TopK_{args.w_topk}_Epoch_wd_{args.epoch_wd}_Wwd_{args.w_wd}_ConfGuided_{args.conf_guided}")
    ...
    args.log_dir = model_dir + f'/{args.dataset_name}_S{str(args.current_step)}-{args.num_steps}_TopK_{args.w_topk}_Epoch_wd_{args.epoch_wd}_Wwd_{args.w_wd}_ConfGuided_{args.conf_guided}_log.txt'
    ...
    # WandB setting
    if args.mode == 'train':
        wandb_run_name = f'Weight-Discrepancy-TopK_{args.model_name}_{args.dataset_name}_S{str(args.current_step)}-{args.num_steps}_TopK_{args.w_topk}_Epoch_wd_{args.epoch_wd}_Wwd_{args.w_wd}_ConfGuided_{args.conf_guided}'
        wandb_tags = [f'TotalStep={args.num_steps}', args.dataset_name, f'Steps={str(args.current_step)}',
                      args.model_name, f'ConfGuided={args.conf_guided}', f'W_wd={args.w_wd}', f'TopK={args.w_topk}',
                      f'Epoch_wd={args.epoch_wd}']
        wandb.init(project='Our_WeightDiscrepancy_Nearest',
