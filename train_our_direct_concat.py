...
from models.build_model import build_direct_concat_model
from data.build_dataset import build_data
from data.config_dataset import set_dataset_config
from methods.direct_concat_learning import DirectConcat
...
if __name__ == "__main__":
    ...
    parser.add_argument('--weights_root', type=str, default='./models/single_weights_wo_l2weights/')
    ...
    # WandB setting
    if args.mode == 'train':
        wandb_run_name = f'Direct-Concat_{args.dataset_name}_{args.model_name}_S{str(args.current_step)}-{args.num_steps}_{args.model_head}_Mlp{args.num_mlp_layers}'
        wandb.init(project='Ours_Direct_Concat_wo_l2_weights',
    ...
    if args.mode == 'train':
        ...
        if args.model_name == 'clip':
            method = DirectConcatClip(model=model, single_head=single_head, learned_single_heads=single_heads_list,
